...
{SENDGRID_ASM_INVITE} = require('smc-util/theme')
        ...
        @get_project mesg, 'write', (err, project) =>
            ...
            async.series([
                ...
                (cb) =>
                    ...
                    # asm_group is set in theme.js https://app.sendgrid.com/suppressions/advanced_suppression_manager
                    opts =
                        to           : locals.email_address
